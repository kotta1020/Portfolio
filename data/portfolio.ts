...
export const additionalWorks: VideoWork[] = [
  ...
  },
  {
    title: "ひな祭りNEWS",
    comment: "今日は楽しいひな祭り",
    url: "https://youtu.be/lTtLilfwLgw",
    youtubeId: "lTtLilfwLgw",
    category: "AIコメディ",
    palette: "blue",
  },
  {
  ...
  {
    title: "こったフェアリーソース新発売！！",
    comment: "なんにでも合う魔法のソース",
    url: "https://youtu.be/yrCUPFiLuqk",
    youtubeId: "yrCUPFiLuqk",
    category: "ショート動画",
    palette: "pink",
  },
  {
    title: "なのだ",
    comment: "オナラ４WD",
    url: "https://youtu.be/56ZVCf05JCk",
    youtubeId: "56ZVCf05JCk",
    category: "ショート動画",
    palette: "pink",
  },
  {
    title: "こったフェアリーちゃんの格言",
    comment: "人生とは〇〇だ",
    url: "https://youtu.be/eASA8whA8NA",
    youtubeId: "eASA8whA8NA",
    category: "ショート動画",
    palette: "pink",
  },
  {
    title: "こった姫を奪い合う男性たち",
    comment: "2026年、ひと夏の恋",
    url: "https://youtu.be/5q7YT2h0MOM",
    youtubeId: "5q7YT2h0MOM",
    category: "AIコメディ",
    palette: "blue",
  },
  {
    title: "からかわないでよ",
    comment: "姫の恥じらい",
    url: "https://youtu.be/4oLbfBJA4ZA",
    youtubeId: "4oLbfBJA4ZA",
    category: "ショート動画",
    palette: "pink",
  },
  {
    title: "喜び授賞式",
    comment: "うれしいから踊ります",
    url: "https://youtube.com/shorts/NG6eypr-_co?feature=share",
    youtubeId: "NG6eypr-_co",
    category: "ショート動画",
    palette: "pink",
  },
  {
    title: "迷惑なパチンコ客",
    comment: "ぱちんかす...",
    url: "https://youtu.be/Tz0wAIgT2jA",
    youtubeId: "Tz0wAIgT2jA",
    category: "ショート動画",
    palette: "pink",
  },
  {
    title: "闇堕ち",
    comment: "タゴサク構文で本音を毒づくこった姫",
    url: "https://youtu.be/Y4qWz8ZauOY",
    youtubeId: "Y4qWz8ZauOY",
    category: "AIコメディ",
    palette: "blue",
  },
  {
    title: "夏の思い出",
    comment: "大きく成長してしまった夏",
    url: "https://youtu.be/RMjODI08_f4",
    youtubeId: "RMjODI08_f4",
    category: "AIコメディ",
    palette: "blue",
  },
  {
    title: "レオタードバスケ",
    comment: "バスケがしたいです...",
    url: "https://youtu.be/sxLIkUDJXtM",
    youtubeId: "sxLIkUDJXtM",
    category: "ショート動画",
    palette: "pink",
  },
  {
    title: "朝の体操をはじめます",
    comment: "これで健康まちがいなし",
    url: "https://youtube.com/shorts/9ike7yOYHEs?feature=share",
    youtubeId: "9ike7yOYHEs",
    category: "AIコメディ",
    palette: "blue",
  },
];
...
export const characters: Character[] = [
  {
    ...
    sheetUrl: "/characters/キャラクターシートこった姫.png",
  },
  {
    name: "こったフェアリーちゃん",
    slug: "kotta-fairy",
    ...
    sheetUrl: "/characters/キャラクターシートこったフェアリーちゃん.png",
  },
  {
    name: "冥土ちゃん",
    slug: "meido-chan",
    ...
    sheetUrl: "/characters/キャラクターシート冥土ちゃん.png",
  },
];
